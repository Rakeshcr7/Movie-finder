...
display = data => {
  if (data.Error) {
    ...
    $("#director").html(`<span class="green-text darken-3" >Director</span> : ${data.Director} `);
    $("#writer").html(`<span class="green-text darken-3" >Writers</span> : ${data.Writer} `);
    $("#casting").html(`<span class="green-text darken-3" >Cast</span> : ${data.Actors} `);
